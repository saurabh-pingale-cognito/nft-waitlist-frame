    ...
    <div className="miniapp-container bg-gradient-to-b from-purple-900/20 to-black rounded-lg shadow-xl flex flex-col items-center justify-center gap-4 max-w-md mx-auto">
      <div className="flex flex-col items-center w-full space-y-4">
        ...
        <input
          ...
          autoFocus
          placeholder="Enter Wallet Address from Waitlist"
        />
        ...
        <button 
          onClick={handleMint} 
          disabled={mintLoading || remaining === 0 || !wallet.trim() || isSupplyLoading}
        ...
        {!isSupplyLoading && remaining === 0 && <p className="text-red-400 text-xs">Supply exhausted!</p>}
      </div>
    </div>
  );
}